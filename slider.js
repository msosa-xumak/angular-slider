      ...
      compile: function(element, attributes) {
        ...
        return {
          post: function(scope, element, attributes) {
            var bar, barWidth, bound, ceilBub, changeFn, dimensions, e, flrBub, handleHalfWidth, highBub, i, j, len, len1, lowBub, maxOffset, maxPtr, maxValue, minOffset, minPtr, minValue, ngDocument, offsetRange, ref1, ref2, selection, transformFn, updateDOM, upper, valueRange, w;
            ref1 = (function() {
            ...
            transformFn = scope.transformFn() || null;
            changeFn = scope.ngChange() || null;
            scope.bubbleValue = function() {
              var ref3, value;
              if ((ref3 = scope.values) != null ? ref3.length : void 0) {
                value = scope.values[scope.local.ngModelLow || scope.local.ngModel || 0];
              } else {
            ...
            updateDOM = function() {
              ...
              bind = function(handle, bubble, ref, events) {
                ...
                onEnd = function() {
                  ...
                  currentRef = ref;
                  if (changeFn) {
                    changeFn(scope.label, scope.local[low]);
                  }
                  return scope.$apply();
                };
